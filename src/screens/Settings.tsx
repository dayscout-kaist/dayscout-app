    ...
    <View style={[fill]}>
      ...
      <ScrollView>
        <View style={[column, gap(12)]}>
          <View style={[bg.white,padding.horizontal(safe.horizontal),padding.vertical(32)]}>
          ...
          <View style={[bg.white,padding.horizontal(safe.horizontal),padding.vertical(32)]}>
            ...
            <View style={[row, justify.between, align.center]}>
              ...
              <View style={[row, round.lg, bg.gray100, justify.between, align.center]}>
                <TextInput
                  style={[text.body1, margin.right(8),margin.bottom(4),{width:48,textAlign: 'right'}]} 
                ...
                />
                <Text style={[text.body1, text.gray500, margin.right(8)]}>cm</Text>
              ...
              <View style={[row, round.lg, bg.gray100,justify.between, align.center]}>
                ...
                <TextInput
                  ...
                  onSubmitEditing={Keyboard.dismiss}
                />
                <Text style={[text.body1,text.gray500,  margin.right(8)]}>kg</Text>
              </View>
            </View>
          </View>
